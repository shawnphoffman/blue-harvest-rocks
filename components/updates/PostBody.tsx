...
const predictionsTheme: PredictionsTheme = {
	accentBar: 'bg-boba-gold',
	cardTitle: 'text-boba-gold',
	summaryTitle: 'text-boba-gold',
	winnerRing: 'ring-boba-gold/60',
	winnerBg: 'bg-boba-gold/10',
	winnerText: 'text-boba-gold',
	winnerIcon: 'text-boba-gold',
}
